...
(define us-coins (list 50 25 10 5 1))
(define us-coins-alt (list 1 5 10 25 50))

(define uk-coins (list 100 50 20 10 5 2 1 0.5))
(define uk-coins-alt (list 50 100 20 1 0.5 2 10 5))

(check-equal? (cc 100 us-coins) 292)
(check-equal? (cc 100 us-coins-alt) 292)
(check-equal? (cc 100 uk-coins) 104561)
(check-equal? (cc 100 uk-coins-alt) 104561)

#|
  Порядок списка на результат не влияет. Потому что алгоритм перебирает все способы размена и никакой
  способ размена не может быть посчитан дважды.
|#
