...
#|
  ...
  Используя div-terms, напишите процедуру remainder-terms, и с ее помощью определите gcd-terms, как
  показано выше. Напишите теперь процедуру gcd-poly, которая вычисляет НОД двух многочленов. (Процедура
  должна сообщать об ошибке, если входные объекты являются многочленами от разных переменных.) Установите
  в систему обобщенную операцию greatest-common-divisor, которая для многочленов сводится к gcd-poly,
  а для обыкновенных чисел к обыкновенному gcd. В качестве проверки, попробуйте ввести
...
#|
  Найдём НОД вручную:
    ...
    𝑥⁴ - 𝑥³ - 2𝑥² + 2𝑥 = 𝑥(𝑥³ - 𝑥) - 𝑥³ - 𝑥² + 2𝑥 = (𝑥 - 1)(𝑥³ - 𝑥) - 𝑥² + 𝑥

  Частное, таким образом, (𝑥 - 1), а остаток от деления -𝑥² + 𝑥.

    𝑥³ - 𝑥 = -𝑥(-𝑥² + 𝑥) + 𝑥² - 𝑥 = -𝑥(-𝑥² + 𝑥) - (-𝑥² + 𝑥) = (-𝑥 - 1)(-𝑥² + 𝑥) + 0

  Частное, таким образом, (-𝑥 - 1), а остаток от деления 0.
